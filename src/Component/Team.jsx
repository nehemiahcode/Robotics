...
function Team() {
  ...
  return (
   <div id="team" className=" pt-14 ">
    <section  className="w-full h-auto mt-16 bg-black grid grid-cols-1 py-10 md:grid-cols-1 lg:grid-cols-2 px-5 md:px-5 sm:px-10 lg:px-16">
   <Fade direction="down">
   <div>
    ...
    <div className="grid md:grid-cols-2 place-content-center grid-cols-1 gap-3">
      {Teams.map((team, index) => (
       <Fade  key={index}>
         <div
          className="relative w-[95%] group mx-auto lg:w-[100%]"
        >
          <img src={team.image} alt="The team" className="rounded-xl sm:mx-auto" />
            <div className={`  group-hover:visible  absolute invisible h-[180px] w-full bottom-0  py-8 bg-[rgba(0,0,0,0.6)]`}>
